...
@SlingServletPaths(value = { "/bin/showpagenames","/geeks/showpagenames" })
public class ShowPageNamesServlet extends SlingAllMethodsServlet {

    private static final Logger LOG = LoggerFactory.getLogger(ShowPageNamesServlet.class);
